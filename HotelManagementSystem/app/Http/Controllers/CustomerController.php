...
class CustomerController extends Controller
{
    ...
    public function addCustomerSubmit(Request $req){
        ...
        // if($req->file('image')->storeAs('/public/imagess/',$filename)){
        //     return "success";
        // }else{
        //     return "Loose";
        // }
    ...
    //     if($customer->save()){
    //         return response()->json(["msg"=>"Signup Successfully"]);
    //     }
    ...
    //     "phoneNumber": "017456566",
    //     "nidNO": "62442552",
    //     "address": "Dhaka",
    //     "gender": "Male",
    //     "age": "23",
    //     "image": "11-2-2021",
    //     "created_at": "2022-08-06T18:44:48.000000Z",
    //     "updated_at": "2022-08-06T18:44:48.000000Z"
    // }
...
///Room categories
 ...
 ///Gym Reserve
    ...
    //     $id = $req->id;
    //     $gym = Gym::where('id', $id)->delete();
    //     return response()->json(["msg"=>"Gym Schedule Deleted Successfully"]);
